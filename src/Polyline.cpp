...
//specifications fo double dispatch
template <class T>
bool Polyline<T>::contains(const Circle<T>& other) const
{
    return Intersections::contains(*this, other);
}
template <class T>
bool Polyline<T>::contains(const LineSegment<T>& other) const
{
    return Intersections::contains(*this, other);
}
template <class T>
bool Polyline<T>::contains(const Polygon<T>& other) const
{
    return Intersections::contains(*this, other);
}
template <class T>
bool Polyline<T>::contains(const Polyline<T>& other) const
{
    return Intersections::contains(*this, other);
}
template <class T>
bool Polyline<T>::contains(const Ray<T>& other) const
{
    return Intersections::contains(*this, other);
}
template <class T>
bool Polyline<T>::contains(const Rectangle<T>& other) const
{
    return Intersections::contains(*this, other);
}
template <class T>
bool Polyline<T>::contains(const Triangle<T>& other) const
{
    return Intersections::contains(*this, other);
}
template <class T>
bool Polyline<T>::contains(const Vec2<T>& other) const
{
    return Intersections::contains(*this, other);
}
