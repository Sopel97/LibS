...
public:
    ...
    Circle<T>& operator =(Circle<T> && other){origin = std::move(other.origin); radius = std::move(other.radius);}
    Circle<T>& operator =(const Circle<T>& other){origin = other.origin; radius = other.radius;}
